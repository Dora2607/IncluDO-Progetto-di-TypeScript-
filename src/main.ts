...
const partecipante4 = new Partecipante(
  "Maria",
  "Gonzalez",
  "Spagna",
  "Laurea",
...
const falegnameria = new Corso(
  "Corso di Falegnameria",
  "Impara l'arte della falegnameria con i migliori artigiani del Sud Italia.",
  "Falegnameria",
  "6 mesi"
);

const ceramica = new Corso(
  "Corso di Ceramica",
  "Scopri le tecniche tradizionali della ceramica e crea le tue opere d'arte.",
  "Ceramica",
  "4 mesi"
);

const sartoria = new Corso(
  "Corso di Sartoria",
  "Diventa un sarto esperto e impara a creare abiti su misura.",
  "Sartoria",
  "5 mesi"
);
...
const azienda1 = new Azienda(
  "Artigiani del Legno",
  "Falegnameria",
  "Azienda specializzata nella lavorazione del legno, con l'obiettivo di tramandare le tecniche tradizionali ai nuovi artigiani.",
  [
...
const azienda2 = new Azienda(
  "Ceramiche d'Arte",
  "Ceramica",
  "Azienda leader nella produzione di ceramiche artistiche, impegnata nella formazione di nuovi ceramisti.",
  [
